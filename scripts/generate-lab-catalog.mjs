...
// 15-40 in another; TSH was 0.5-5.0 in one and 0.4-4.0 in another. A catalogue that is
// green against the wrong reference intervals is worse than none at all, because it
// certifies the defect.
//
// So the catalogue is authored ONCE, in TypeScript where it is type-checked, and every
// other representation is generated from it:
//
//   supabase/migrations/<CATALOG_VERSION>.sql                    the reference table
//
//   node scripts/generate-lab-catalog.mjs           # write it
//   node scripts/generate-lab-catalog.mjs --check   # CI: fail if it is stale
//
// A second output — e2e/fixtures/mock-data.json, for the Playwright suite — was dropped
// on 2026-09-05 when the QA content was removed. It was generated by merging into the
// existing fixture, so once that file was deleted the generator could not rebuild it and
// crashed on startup in BOTH modes, taking the SQL emission down with it. If the e2e
// suite returns, regenerate the fixture from scratch rather than restoring the merge.
//
