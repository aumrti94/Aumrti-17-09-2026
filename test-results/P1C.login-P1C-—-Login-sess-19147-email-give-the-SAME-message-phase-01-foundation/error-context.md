...
- Name: phase-01-foundation\P1C.login.spec.ts >> P1C — Login & session >> TC-P1C-002/003 wrong password and unknown email give the SAME message
- Location: e2e\phase-01-foundation\P1C.login.spec.ts:24:3

# Error details

```
Error: The wrong-password and unknown-email responses differ, which leaks whether an account exists.

expect(received).toBe(expected) // Object.is equality

Expected: "aumrti monday, 27 july 2026 12:31:28 pm 🌅 morning shift every login matters. every patient counts. powered by aumrti welcome back sign in to continue email address password remember me forgot password? invalid credentials. please try again. sign in or continue with google microsoft facebook don't have an account? register your hospital →"
Received: "aumrti monday, 27 july 2026 12:31:25 pm 🌅 morning shift every login matters. every patient counts. powered by aumrti welcome back sign in to continue email address password remember me forgot password? invalid credentials. please try again. sign in or continue with google microsoft facebook don't have an account? register your hospital →"
```
    ...
    - generic [ref=e14]:
      ...
      - generic [ref=e18]:
        - generic [ref=e19]:
          ...
          - generic [ref=e20]:
            - img [ref=e21]
            - textbox "Enter your email" [ref=e24]: nosuchuser-qa@example.com
        - generic [ref=e25]:
          - text: Password
          - generic [ref=e26]:
            - textbox "Enter your password" [ref=e27]: WrongPass@2026
